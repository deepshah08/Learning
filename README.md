...
| **Networking & Protocols** | DNS Handoff & Contract | Dual Split-Scope DHCP, Sub-500ms DNS Waterfall, Break-Glass Protocol | [networking/DNS_NETWORK_HANDOFF.md](networking/DNS_NETWORK_HANDOFF.md) |
| **Networking & Protocols** | Incident Post-Mortem | SEV-1 RCA: Wi-Fi Disconnection & DHCP Starvation Post-Mortem | [networking/INCIDENT_2026_08_31_DHCP_OUTAGE_RCA.md](networking/INCIDENT_2026_08_31_DHCP_OUTAGE_RCA.md) |
| **Raspberry Pi 5** | System & Hardware | Host access, OS tuning, VMs, hardware devices | [raspberrypi/README.md](raspberrypi/README.md) |
| **Raspberry Pi 5** | Secondary DNS & Standby DHCP | Secondary DNS + Unbound :5335 + Standby Split-Scope DHCP + Keep-Alive | [raspberrypi/pihole/README.md](raspberrypi/pihole/README.md) |
...
| **UGREEN DXP2800** | 2.5GbE DHCP & SRE Watchdog | Authoritative Primary DHCP (`nas_dhcp_server`) + Native SLO Watchdog | [ugreen_nas/dhcp_server/README.md](ugreen_nas/dhcp_server/README.md) |
...
| **UGREEN DXP2800** | Primary DNS Resolver | High-Availability Primary DNS on 2.5GbE, 1:1 Parity (298k domains) | [ugreen_nas/pihole/README.md](ugreen_nas/pihole/README.md) |
...
| **UGREEN DXP2800** | Thermal & Resource Tuning | Fan curves, CPU thermals, Plex commercial scan disablement, maintenance window | [ugreen_nas/NAS_FAN_AND_RESOURCE_OPTIMIZATION.md](ugreen_nas/NAS_FAN_AND_RESOURCE_OPTIMIZATION.md) |
| **CI/CD & Agentic Swarms** | 100-Project Swarm Orchestration | Autonomous 100-session Jules multi-agent swarm execution, sliding-window orchestration & Project 100 Master Dashboard | [ci_cd_and_agentic_pipelines/100_PROJECT_HOMELAB_SWARM_ORCHESTRATION.md](ci_cd_and_agentic_pipelines/100_PROJECT_HOMELAB_SWARM_ORCHESTRATION.md) |
| **CI/CD & Agentic Swarms** | CruxDAG + SimuVerse Pathfinder | Independent reading-first concept DAG, provenance reader, and optional simulation handoff | [ci_cd_and_agentic_pipelines/cruxdag_simuverse/cruxdag_simuverse_knowledge.md](ci_cd_and_agentic_pipelines/cruxdag_simuverse/cruxdag_simuverse_knowledge.md) |
| **Hardware & Diagnostics** | Google Pixel 1 (`sailfish`) | Hardware battery voltage sag telemetry, WPA3-SAE association failure & fix | [hardware_and_diagnostics/pixel1/README.md](hardware_and_diagnostics/pixel1/README.md) |
| **Hardware & Diagnostics** | Flipper Zero (`Epriesol`) | Multi-tool runbook, SPI MicroSD filesystem, serial CLI, RF/IR/BadUSB databases | [hardware_and_diagnostics/flipper_zero/README.md](hardware_and_diagnostics/flipper_zero/README.md) |
| **Hardware & Diagnostics** | GEEKOM IT13 Max | Deployed local knowledge/execution stack, investigation, and decision rationale | [hardware_and_diagnostics/it13max_compute_node/README.md](hardware_and_diagnostics/it13max_compute_node/README.md) |
| **Storage & Archival** | SMR Sequential Streaming | High-speed zero-local-footprint tar/zstd streaming to SMR drives | [storage/SMR_SEQUENTIAL_STREAMING_RUNBOOK.md](storage/SMR_SEQUENTIAL_STREAMING_RUNBOOK.md) |
| **Performance & Benchmarking** | Algorithmic Optimization Ledger | Verified complexity reductions ($O(N^2) \to O(N)$), I/O savings, and normalized metrics | [SYSTEMS_BENCHMARKING_AND_OPTIMIZATIONS.md](SYSTEMS_BENCHMARKING_AND_OPTIMIZATIONS.md) |
| **Master Roadmap** | 100-Project Execution Queue | Single Source of Truth tracking active and completed ecosystem projects | [PROJECTS_ROADMAP.md](PROJECTS_ROADMAP.md) |
