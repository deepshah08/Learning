...
| **27** | **Zero-Copy Photo Direct Mount Pipeline** | Storage / Optimization Queue | 📝 Staged / Queue | Read-Only Bind Mount (`/volume1` $ightarrow$ Redroid) + Inotify Scan | Architecture Documented ([Docs](ugreen_nas/storage/PHOTO_TIERED_STORAGE_DESIGN.md)) |
...
| **101** | **GEEKOM IT13 Max AI & Compute Node** | Compute / Local AI | ✅ Goals 1–6 deployed; independent remediation review pending | Intel Core Ultra 9 185H + Arc | [Hardware and MDS docs](hardware_and_diagnostics/it13max_compute_node/README.md) · [Private implementation repo](https://github.com/deepshah08/it13max) |
